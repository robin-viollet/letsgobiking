 ...
 * 
 */
@WebServiceClient(name = "Server", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8733/Design_Time_Addresses/RoutingServer/Server/?wsdl")
public class Server
    extends Service
{
    ...
    private final static QName SERVER_QNAME = new QName("http://tempuri.org/", "Server");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8733/Design_Time_Addresses/RoutingServer/Server/?wsdl");
